...
export const Stats: React.FC<StatsProps> = ({ darkMode }) => {
  ...
  const achievements: Achievement[] = [
    {
      icon: Award,
      title: t("stats.presidential"),
      description: t("stats.presidentialDesc"),
    },
    {
      icon: CheckCircle,
      title: t("stats.iso"),
      description: t("stats.isoDesc"),
    },
    {
      icon: TrendingUp,
      title: t("stats.digital2030"),
      description: t("stats.digital2030Desc"),
    },
    {
      icon: Network,
      title: t("stats.collaboration"),
      description: t("stats.collaborationDesc"),
    },
  ];
